...
function preload(){
    ...
    skeletonimg = loadAnimation("gob1.png","gob2.png","gob3.png","gob4.png","gob5.png","gob6.png","gob7.png","gob8.png")
}
function setup(){
...
player2.addAnimation("hi",guy_running)
  ...
  skeleton = createSprite(1200,height-130,20,20)
  skeleton.addAnimation("hi",skeletonimg)
  skeleton.scale = 5
  skeleton.visible = false;

  skeleton1 = createSprite(1200,height-130,20,20)
  skeleton1.addAnimation("hi",skeletonimg)
  skeleton1.scale = 5
  skeleton1.visible = false;

  skeleton2 = createSprite(1200,height-130,20,20)
  skeleton2.addAnimation("hi",skeletonimg)
  skeleton2.scale = 5
